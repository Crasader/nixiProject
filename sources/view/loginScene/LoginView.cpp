...
{
    CCSprite* spt_inputbox = CCSprite::create("pic/loginScene/login_box.png");
    ...
    CCSprite* login_effect = CCSprite::create("pic/loginScene/login_btn_login.png");
    ...
    CCSprite* regist_normal = CCSprite::create("pic/loginScene/login_btn_regist.png");
    CCSprite* regist_effect = CCSprite::create("pic/loginScene/login_btn_regist.png");
