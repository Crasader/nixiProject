...
{
    CCSprite* spt_inputbox = CCSprite::create("pic/loginScene/regist_box.png");
    ...
    _tf_password2 = CCEditBox::create(CCSizeMake(size_bar.width - 20, size_bar.height), CCScale9Sprite::create("pic/loginScene/99.png"));
    ...
    //
    CCSprite* regist_normal = CCSprite::create("pic/loginScene/login_regist.png");
    CCSprite* regist_effect = CCSprite::create("pic/loginScene/login_regist.png");
    ...
    CCSprite* login_normal = CCSprite::create("pic/loginScene/login_return.png");
    CCSprite* login_effect = CCSprite::create("pic/loginScene/login_return.png");
