...
#ifndef __tiegao__VipQingjingTableView__
#define __tiegao__VipQingjingTableView__
...
class VipQingjingTableView
: public CCLayer
, public CCTableViewDataSource
, public CCTableViewDelegate
{
public:
    VipQingjingTableView();
    ~VipQingjingTableView();
    
    virtual bool init();
    
    
    CREATE_FUNC(VipQingjingTableView);
...
#endif /* defined(__tiegao__VipQingjingTableView__) */
