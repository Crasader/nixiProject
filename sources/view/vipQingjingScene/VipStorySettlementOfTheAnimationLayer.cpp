//
//  VipStorySettlementOfTheAnimationLayer.cpp
//  tiegao
//
...
void VipStorySettlementOfTheAnimationLayer::onEnter(){
    CCLayer::onEnter();
    
}
void VipStorySettlementOfTheAnimationLayer::onExit(){
    
    setTouchEnabled(false);
    CCLayer::onExit();
}

bool VipStorySettlementOfTheAnimationLayer::init(){
    bool bRet = false;
    ...
    do {
        ...
        this->scheduleOnce(SEL_SCHEDULE(&VipStorySettlementOfTheAnimationLayer::openTouch), 1.f);
...
VipStorySettlementOfTheAnimationLayer* VipStorySettlementOfTheAnimationLayer::create_with_index(int index, std::string ending){
    VipStorySettlementOfTheAnimationLayer* rtn = VipStorySettlementOfTheAnimationLayer::create();
...
//    this->addChild(mask, 10);
    ...
    if (index == 1) {
        ...
        CCCallFunc* callFunc = CCCallFunc::create(this, SEL_CallFunc(&VipStorySettlementOfTheAnimationLayer::closeCallBack));
        ...
        this->schedule(SEL_SCHEDULE(&VipStorySettlementOfTheAnimationLayer::creatStar1), .5f + CCRANDOM_MINUS1_1()*.2f);
        this->schedule(SEL_SCHEDULE(&VipStorySettlementOfTheAnimationLayer::creatStar2), .5f + CCRANDOM_MINUS1_1()*.2f);
        this->schedule(SEL_SCHEDULE(&VipStorySettlementOfTheAnimationLayer::creatStar3), .5f + CCRANDOM_MINUS1_1()*.2f);
        this->schedule(SEL_SCHEDULE(&VipStorySettlementOfTheAnimationLayer::creatStar4), .5f + CCRANDOM_MINUS1_1()*.2f);
        this->schedule(SEL_SCHEDULE(&VipStorySettlementOfTheAnimationLayer::creatStar5), .5f + CCRANDOM_MINUS1_1()*.2f);
        this->schedule(SEL_SCHEDULE(&VipStorySettlementOfTheAnimationLayer::creatStar6), .5f + CCRANDOM_MINUS1_1()*.2f);
...
bool VipStorySettlementOfTheAnimationLayer::ccTouchBegan(CCTouch *pTouch, CCEvent *pEvent){
...
void VipStorySettlementOfTheAnimationLayer::openTouch(float dt){
    this->setTouchEnabled(true);
}


void VipStorySettlementOfTheAnimationLayer::creatStar1(float dt){
    this->unschedule(SEL_SCHEDULE(&VipStorySettlementOfTheAnimationLayer::creatStar1));
    ...
    this->schedule(SEL_SCHEDULE(&VipStorySettlementOfTheAnimationLayer::creatStar1), 1.f + CCRANDOM_MINUS1_1()*.2f);
}
void VipStorySettlementOfTheAnimationLayer::creatStar2(float dt){
    this->unschedule(SEL_SCHEDULE(&VipStorySettlementOfTheAnimationLayer::creatStar2));
    ...
    this->schedule(SEL_SCHEDULE(&VipStorySettlementOfTheAnimationLayer::creatStar2), 1.f + CCRANDOM_MINUS1_1()*.2f);
}
void VipStorySettlementOfTheAnimationLayer::creatStar3(float dt){
    this->unschedule(SEL_SCHEDULE(&VipStorySettlementOfTheAnimationLayer::creatStar3));
    ...
    this->schedule(SEL_SCHEDULE(&VipStorySettlementOfTheAnimationLayer::creatStar3), 1.f + CCRANDOM_MINUS1_1()*.2f);
}
void VipStorySettlementOfTheAnimationLayer::creatStar4(float dt){
    this->unschedule(SEL_SCHEDULE(&VipStorySettlementOfTheAnimationLayer::creatStar4));
    ...
    this->schedule(SEL_SCHEDULE(&VipStorySettlementOfTheAnimationLayer::creatStar4), 1.f + CCRANDOM_MINUS1_1()*.2f);
}
void VipStorySettlementOfTheAnimationLayer::creatStar5(float dt){
    this->unschedule(SEL_SCHEDULE(&VipStorySettlementOfTheAnimationLayer::creatStar5));
    ...
    this->schedule(SEL_SCHEDULE(&VipStorySettlementOfTheAnimationLayer::creatStar5), 1.f + CCRANDOM_MINUS1_1()*.2f);
}
void VipStorySettlementOfTheAnimationLayer::creatStar6(float dt){
    this->unschedule(SEL_SCHEDULE(&VipStorySettlementOfTheAnimationLayer::creatStar6));
    ...
    this->schedule(SEL_SCHEDULE(&VipStorySettlementOfTheAnimationLayer::creatStar6), 1.f + CCRANDOM_MINUS1_1()*.2f);
}
