...
#ifndef __tiegao__VipQingjingCoverView__
#define __tiegao__VipQingjingCoverView__
...
public:
     ...
     * @param card之间的缩放
     */
    static VipQingjingCoverView* create(CCRect swBox, CCSize slSize ,float disDistance , float disScale );
...
#endif /* defined(__tiegao__VipQingjingCoverView__) */
