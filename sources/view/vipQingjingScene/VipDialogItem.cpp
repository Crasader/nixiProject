...
bool VipDialogItem::init()
{
    return true;
}


void VipDialogItem::config_static_with_json(CSJson::Value value)
{
    // 当前场景的id
...
void VipDialogItem::clues_config_static_with_json(CSJson::Value value){
