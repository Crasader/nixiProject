...
VipLabelColorLayer::VipLabelColorLayer(){
...
void VipLabelColorLayer::onEnter(){
    CCLayer::onEnter();
    
    
}
void VipLabelColorLayer::onExit(){
    
    setTouchEnabled(false);
    CCLayer::onExit();
}

bool VipLabelColorLayer::init(){
    bool bRet = false;
...
//        gbSpr2->setScale(.81f);
//        CCMenuItem* gbItem = CCMenuItemSprite::create(gbSpr1, gbSpr2, this, menu_selector(VipLabelColorLayer::fhCallBack));
...
void VipLabelColorLayer::fhCallBack(CCObject* pSender){
...
//    }
    ...
    CCNotificationCenter::sharedNotificationCenter()->postNotification("LabelColorFhCallBack");
}

VipLabelColorLayer* VipLabelColorLayer::create_with_index(const char* text){
    VipLabelColorLayer* rtn = VipLabelColorLayer::create();
    rtn->init_with_index(text);
    
    return rtn;
}
void VipLabelColorLayer::init_with_index(const char* text){
...
void VipLabelColorLayer::creatLabel(){
...
//                m_pLabel->enableStroke(ccc3(80, 63, 68), .4f);
    ...
    CCMenuItem* m_button_left = CCMenuItemSprite::create(leftSpr1, leftSpr2, leftSpr3, this, SEL_MenuHandler(&VipLabelColorLayer::on_left_button_clicked));
    ...
    CCMenuItem* m_button_right = CCMenuItemSprite::create(rightSpr1, rightSpr2, rightSpr3, this, SEL_MenuHandler(&VipLabelColorLayer::on_right_button_clicked));
...
void VipLabelColorLayer::on_left_button_clicked(CCObject* pSender){
...
void VipLabelColorLayer::on_right_button_clicked(CCObject* pSender){
    the_current_number_of_pages++;
...
bool VipLabelColorLayer::ccTouchBegan(CCTouch *pTouch, CCEvent *pEvent){
...
CCRect VipLabelColorLayer::isDkRect(){
    return CCRectMake(-223, -203, 448, 632);
}
bool VipLabelColorLayer::isDkContainTouchPoint1(CCTouch* touch){
