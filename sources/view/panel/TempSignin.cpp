...
void TempSignin::onEnter() {
    ...
    CCNotificationCenter::sharedNotificationCenter()->addObserver(this, SEL_CallFuncO(&TempSignin::signin_callback_303), "HTTP_FINISHED_303", NULL);
...
void TempSignin::config_siginInfo(){
    ...
    CCARRAY_FOREACH(arr, obj){
        ...
        // ----
        SigninState cur_state = DATA->fetch_signin7_state(DATA->getTempSigninUserdata(), id);
...
void TempSignin::signin_callback_303(){
    LOADING->remove();
