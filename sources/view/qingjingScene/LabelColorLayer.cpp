...
LabelColorLayer::LabelColorLayer(){
...
void LabelColorLayer::onEnter(){
    CCLayer::onEnter();
    
    
}
void LabelColorLayer::onExit(){
    
    setTouchEnabled(false);
    CCLayer::onExit();
}

bool LabelColorLayer::init(){
    bool bRet = false;
...
//        gbSpr2->setScale(.81f);
//        CCMenuItem* gbItem = CCMenuItemSprite::create(gbSpr1, gbSpr2, this, menu_selector(LabelColorLayer::fhCallBack));
...
void LabelColorLayer::fhCallBack(CCObject* pSender){
...
LabelColorLayer* LabelColorLayer::create_with_index(const char* text){
    LabelColorLayer* rtn = LabelColorLayer::create();
    rtn->init_with_index(text);
    
    return rtn;
}
void LabelColorLayer::init_with_index(const char* text){
...
void LabelColorLayer::creatLabel(){
...
//                m_pLabel->enableStroke(ccc3(80, 63, 68), .4f);
    ...
    CCMenuItem* m_button_left = CCMenuItemSprite::create(leftSpr1, leftSpr2, leftSpr3, this, SEL_MenuHandler(&LabelColorLayer::on_left_button_clicked));
    ...
    CCMenuItem* m_button_right = CCMenuItemSprite::create(rightSpr1, rightSpr2, rightSpr3, this, SEL_MenuHandler(&LabelColorLayer::on_right_button_clicked));
...
void LabelColorLayer::on_left_button_clicked(CCObject* pSender){
...
void LabelColorLayer::on_right_button_clicked(CCObject* pSender){
    the_current_number_of_pages++;
...
bool LabelColorLayer::ccTouchBegan(CCTouch *pTouch, CCEvent *pEvent){
...
CCRect LabelColorLayer::isDkRect(){
    return CCRectMake(-223, -203, 448, 632);
}
bool LabelColorLayer::isDkContainTouchPoint1(CCTouch* touch){
