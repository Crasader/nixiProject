...
#ifndef __manman_client__DialogItem__
#define __manman_client__DialogItem__
...
class DialogItem : public CCObject
{
public:
    ~DialogItem();
    CREATE_FUNC(DialogItem);
    bool init();
...
#endif /* defined(__manman_client__DialogItem__) */
