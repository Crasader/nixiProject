...
LOCAL_SRC_FILES := entryexpro/libentryexpro.so
LOCAL_SHARED_LIBRARIES := entryexpro_shared
include $(PREBUILT_SHARED_LIBRARY)

include $(CLEAR_VARS)
   
LOCAL_MODULE := uptsmaddon_shared
LOCAL_SRC_FILES := uptsmaddon/libuptsmaddon.so
LOCAL_SHARED_LIBRARIES := uptsmaddon_shared
include $(PREBUILT_SHARED_LIBRARY)
